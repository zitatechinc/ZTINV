...
from inventory.models import  PurchaseOrderHeader,PurchaseOrderStatus,PurchaseOrderType,PurchaseOrderType,GoodsMovementHeader,GoodsMovementItem,PurchaseOrderItem,PurchaseOrderHistory
import random

...
from vendor.models import Vendor, VendorAttachment, VendorTax, VendorBank,ProductVendor,VendorUpload,VendorType
...
from project.models import ProjectHeader, BOMHeader, ProjectComponent, BOMItem,BOMAttachments,VoucherHeader,VoucherComponent

class Command(BaseCommand):
    help = "Setup standardized role-based permissions for all models."

    ROLE_PERMISSIONS = {
        "Administrator": ["can_create", "can_edit", "can_delete", "can_view","can_history"],
    ...
    MODEL_CLASSES = [
        ...
        Country, ProductLinks, ProductAttribute, Attribute,
        AppSettings, Themes,  Product,Country,Location, SubLocation,VendorType,
        Vendor, VendorAttachment, VendorTax, VendorBank,ProductVendor,VendorUpload,ProductUpload,ProductGroup,
        PurchaseOrderType, PurchaseOrderStatus, PurchaseOrderHeader, PurchaseOrderItem, GoodsMovementHeader, GoodsMovementItem, PurchaseOrderHistory, Inventory,
        Customer,ProjectHeader, BOMHeader, ProjectComponent, BOMItem,BOMAttachments,VoucherHeader,VoucherComponent
    ]
